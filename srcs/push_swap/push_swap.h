...
/*   Updated: 2024/03/28 13:19:55 by eagranat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					case_rrarrb(t_stack *stack_a, t_stack *stack_b,
						int num_push);
int					case_rrarb(t_stack *stack_a, t_stack *stack_b,
						int num_push);
int					case_rarrb(t_stack *stack_a, t_stack *stack_b,
						int num_push);
int					case_rrarrb_a(t_stack *a, t_stack *b, int c);
int					case_rarb_a(t_stack *stack_a, t_stack *stack_b,
						int num_push);
int					case_rarrb_a(t_stack *stack_a, t_stack *stack_b,
						int num_push);
int					case_rrarb_a(t_stack *stack_a, t_stack *stack_b,
						int num_push);
int					sign(int c);
int					digit(int c);
int					space(int c);
